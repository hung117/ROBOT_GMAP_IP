...
function getData_wait() {
  response_obj = [];
  fs.readdir(server_database, (err, files) => {
        ...
        fs.readFile(filePath, "utf8", function (err, data) {
          ...
          if (err) console.log(err);
            ...
            if (validateJSON(data)) {
              ...
              img = { image: contents };
              Object.assign(response_obj, { image: contents });
            }
          }
        });
      }
        ...
        fs.readFile(filePath, "utf8", function (err, data) {
          if (err) console.log(err);
            ...
            if (validateJSON(data) || validateImage(file)) {
              filePath = robot_output + "/" + file;
              upload_file_path = server_database + "/" + file;
